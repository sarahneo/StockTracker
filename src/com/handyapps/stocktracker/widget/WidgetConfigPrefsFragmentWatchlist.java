...
public class WidgetConfigPrefsFragmentWatchlist extends PreferenceFragment implements OnSharedPreferenceChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (bundle != null) {
			...
			status_old = bundle.getBoolean(WidgetProviderWatchlist.APP_WIDGET_STATUS_OLD_WATCHLIST, false);
	...
	private void sendMyBroadcasetUpdateWidget() {
		Intent updateWidgetIntent = new Intent(getActivity(), WidgetProviderWatchlist.class);
	...
	private void updateWidgetByGivenAppWidgetId() {
		...
		WidgetProviderWatchlist.updateAppWidget(getActivity(), appWidgetManager, mAppWidgetId, false, false, false);
	}
